...
| [Schema composition](https://github.com/marvin-hsu/tsp-asyncapi/tree/main/examples/03-schema-composition)           | 用既有 schema 組出新 schema 的四種方式，以及沒有專屬 decorator 時用的 `@jsonSchemaExtension`。 |
