...
輸出已經 commit，所以不必執行任何東西就能對照輸入與輸出。十四份都通過官方 AsyncAPI parser。
...
| [Schema composition](https://github.com/marvin-hsu/tsp-asyncapi/tree/main/examples/03-schema-composition)           | 用既有 schema 組出新 schema 的四種方式，以及 raw schema 逃生口。         |
...
| [Kafka user signup](https://github.com/marvin-hsu/tsp-asyncapi/tree/main/examples/08-kafka-user-signup)             | 一份真實的 Kafka 契約，四層 Kafka binding 齊全。                         |
