        ...
        sidebar: [
          {
            ...
            items: [
              ...
              { text: "Protobuf Payloads", link: "/guide/protobuf-payloads" },
              { text: "Avro Payloads", link: "/guide/avro-payloads" },
              { text: "Avro Schemas", link: "/guide/avro-schemas" },
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Reusable Components", link: "/reference/reusable-components" },
        ...
        sidebar: [
          {
            ...
            items: [
              ...
              { text: "Protobuf payload", link: "/zh-tw/guide/protobuf-payloads" },
              { text: "Avro payload", link: "/zh-tw/guide/avro-payloads" },
              { text: "Avro schema", link: "/zh-tw/guide/avro-schemas" },
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                collapsed: false,
                items: [
                  { text: "Document Info", link: "/zh-tw/reference/decorators/document-info" },
                  { text: "Server", link: "/zh-tw/reference/decorators/servers" },
                  { text: "Security", link: "/zh-tw/reference/decorators/security" },
                  { text: "Channel", link: "/zh-tw/reference/decorators/channels" },
                  { text: "Operation", link: "/zh-tw/reference/decorators/operations" },
                  { text: "Message", link: "/zh-tw/reference/decorators/messages" },
                  { text: "Schema 與內建 decorator", link: "/zh-tw/reference/decorators/schemas" },
                ],
              },
              {
                text: "通訊協定 binding",
