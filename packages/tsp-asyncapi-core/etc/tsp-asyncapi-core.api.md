...
readonly default: CallableMessage<["name", "message", "decorator"]>;
};
"avro-artifact-unavailable": {
readonly default: CallableMessage<["name", "reason"]>;
};
...
"unknown-oauth-scope": {
readonly default: CallableMessage<["scope"]>;
};
"invalid-url": {
